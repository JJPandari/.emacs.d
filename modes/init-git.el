...
(after-load 'magit
  ...
  (add-hook 'magit-popup-mode-hook 'jester/no-trailing-whitespace))
...
;;   (defun jester/maybe-enable-magit-svn-mode ()
;;     (when (magit-svn-enabled)
;;       (magit-svn-mode)))
;;   (add-hook 'magit-status-mode-hook #'jester/maybe-enable-magit-svn-mode))
